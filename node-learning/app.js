...
function readFileContent() {
  const path = "example.txt"; // replace with your file path
...
function logMessageToFile(message) {
  ...
  fs.appendFile("logs.txt", logMessage, (err) => {
    if (err) {
      ...
      console.log("Log message written to logs.txt");
    }
  });
}

// logMessageToFile("This is a test log message.");
...
function readFilesInDirectory() {
  const dirPath = "./"; // specify your directory path here
